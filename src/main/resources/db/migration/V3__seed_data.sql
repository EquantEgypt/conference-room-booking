...
INSERT INTO users (role, first_name, last_name, phone, business_email, password, department_id, job_id) VALUES
...
INSERT INTO meeting_rooms (name, capacity, building, floor, geo_location, equipment, operating_hours_start, operating_hours_end, room_type, status) VALUES
...
INSERT INTO reservations (description, start_time, end_time, reservation_type, recurrence_option, user_id, room_id) VALUES
('Sprint Planning', '2025-09-05 09:00:00', '2025-09-05 10:00:00', 'INTERNAL', 'WEEKLY',
    ...
    (SELECT id FROM meeting_rooms WHERE name = 'Sphinx')
),
('Project Review', '2025-09-06 14:00:00', '2025-09-06 15:30:00', 'EXTERNAL', 'ONE_TIME',
    ...
    (SELECT id FROM meeting_rooms WHERE name = 'Philae')
),
('Weekly Standup', '2025-09-07 10:00:00', '2025-09-07 10:30:00', 'INTERNAL', 'WEEKLY',
    ...
    (SELECT id FROM meeting_rooms WHERE name = 'Cleopatra')
),
('HR Meeting', '2025-09-08 11:00:00', '2025-09-08 12:00:00', 'INTERNAL', 'ONE_TIME',
    ...
    (SELECT id FROM meeting_rooms WHERE name = 'Nefertiti')
),
